...
let main =
    ...
    printfn " | %10.5f | %10.5f | %10.5f|" (dichotomy f1 2. 4.) (iterations phi1 4.) (newthon f1 f1' 2.)
    printfn " |%10.5f  | %10.5f | %10.5f|" (dichotomy f2  1. 2.) (iterations phi2 1.) (newthon f2 f2' 2.)
